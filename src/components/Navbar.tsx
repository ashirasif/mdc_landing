...
function Navbar() {
  ...
  const navs = [
    ...
    {
      title: "Services",
      dropDownItems: [{ title: "Aerospace & Defence" }, 
        {title: 'Research & Development'},
        {title: 'Cybersecurity Services'},
        {title: 'Principals and OEMs'},],
    },
    {
      title: "Our Team",
    },
            ...
            {navs.map((nav, i) => {
              {
                if (nav.title !== "Services")
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        nav.title !== "Home" && "lg:border-transparent"
                      )}
                    >
                      {nav.title}
                    </div>
                  ...
                  <div
                      key={i}
                      className={cn(
                        "flex items-center p-2 gap-2 cursor-pointer hover:border-b lg:border-foreground border-transparent active:border-b active:rounded-lg active:bg-secondary hover:border-foreground transition-colors duration-500",
                      )}
                    >
                      {nav.title}
                  ...
                  <DropdownMenuContent>
                    ...
                    {nav.dropDownItems?.map((dropdownItem) => (
                      <DropdownMenuItem key={dropdownItem.title} className="w-full p-4 bg-secondary hover:bg-primary-foreground text-primary-foreground text-base hover:text-secondary border hover:border-b border-borderColor  cursor-pointer outline-none">
