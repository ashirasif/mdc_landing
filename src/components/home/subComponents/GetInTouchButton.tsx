...
function GetInTouchButton(props:{shadow:boolean}) {
  ...
  return (
    <button className={`py-4 px-6 rounded-lg min-w-56 duration-200 cursor-pointer w-60 lg:w-auto my-4 lg:my-0 ${props.shadow&&'shadow-heroBtn border-0'} bg-white hover:bg-inherit text-secondary hover:text-primary-foreground flex gap-2 justify-center border hover:border-[#F9F6F3] items-center`}
